...
document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('http://192.168.1.7:3200/auth/me', {
      method: 'GET',
      headers: {
...
function getUserPoints() {
  ...
  async function consultarPuntos() {
    ...
    const response = await fetch(`http://192.168.1.7:3200/auth/points/${userId}`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`,
...
function profile() {
    ...
    .then(data => {
        if (data) {
            ...
            fetch(`http://192.168.1.7:3200/auth/points/${userId}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
...
function solicitar() {
    ...
    function sendRequest(requestData) {
        fetch('http://192.168.1.7:3200/auth/requests', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`,
...
function listar(){
    fetch('http://192.168.1.7:3200/auth/requests/all', {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`,
...
document.getElementById('cerrar-sesion').addEventListener('click', function(event) {
    ...
    fetch('http://192.168.1.7:3200/auth/logout', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`,
...
async function displayContainers() {
    ...
    try {
        const response = await fetch('http://192.168.1.7:3200/user/containers');
...
function openContainerModal(container) {
    ...
    document.getElementById('sendRequestButton').addEventListener('click', async () => {
        ...
        await fetch('http://192.168.1.7:3200/auth/requests', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
