const BASE_URL = "http://192.168.1.7:3200";
let token;
...
function loadRequests() {
  fetch('http://192.168.1.7:3200/admin/requests/all/clients', {
      method: 'GET',
      headers: {
...
function viewRequestDetails(requestId) {
    fetch(`http://192.168.1.7:3200/admin/request/${requestId}`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
  ...
  if (requestTitle === "Recolección de material") {
      ...
      document.getElementById('finish-request-confirm-button').onclick = function () {
          ...
          if (rating <= 0) {
              ...
              fetch(`http://192.168.1.7:3200/admin/request/finish/${requestId}`, {
                  method: 'POST',
                  headers: {
                      'Content-Type': 'application/json',
                      'Authorization': `Bearer ${token}`
...
function loadClients(page = 1) {
    const url = `http://192.168.1.7:3200/admin/clients?page=${page}`;
...
function toggleClientDetails(clientBox, clientId) {
    ...
    if (isExpanded) {
        ...
        fetch(`http://192.168.1.7:3200/admin/clients/${clientId}/requests`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
...
function loadProductManagement() {
  ...
  function fetchProducts() {
    fetch('http://192.168.1.7:3200/admin/products', {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
  ...
  function deleteProduct(productId) {
    ...
    fetch(`http://192.168.1.7:3200/admin/delete/product/${productId}`, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
  ...
  function updateProduct(productId) {
    ...
    fetch(`http://192.168.1.7:3200/admin/update/product/${productId}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  document.getElementById('content-area').addEventListener('submit', function(event) {
    if (event.target && event.target.id === 'create-product-form') {
      ...
      fetch('http://192.168.1.7:3200/admin/create/product', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  async function handleContainerRequest(requestId) {
    try {
      const response = await fetch(`http://192.168.1.7:3200/admin/request/${requestId}`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
      ...
      document.getElementById('finalizeContainerRequest').onclick = async function () {
        ...
        try {
          const updateRequestResponse = await fetch(`http://192.168.1.7:3200/admin/request/finish/${requestId}`, {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'Authorization': `Bearer ${token}`
          ...
          /*if (completed && request.containerId) {
            const updateContainerResponse = await fetch(`http://192.168.1.7:3200/user/containers/${request.containerId}  `, {
              method: 'PUT',
              headers: {
                'Content-Type': 'application/json',
